...
export const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className="mb-6">
      <label
        className={`${
          labelcolor ? "text-" + labelcolor : "text-gray-900"
...
export const Spinner: React.FC<SpinnerProps> = ({
  ...
  return (
    <div role="status" className="flex flex-col justify-center items-center">
      ...
      <svg
        aria-hidden="true"
        className={`w-${size} h-${size} text-gray-200 animate-spin dark:text-gray-600 fill-ui-primary`}
        viewBox="0 0 100 100"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="50" cy="50" r="45" fill="none" stroke="#FF5722" strokeWidth="3" strokeLinecap="round">
          <animateTransform
