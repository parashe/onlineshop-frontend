...
import { Alert, Button, SelectWithArrow, Spinner } from "../Atom/atom";
...
const ProductDetailsCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <section className=" container mx-auto  ">
      <div className="md:mt-10 mb-10  md:px-20 xl:px-32 ">
        <div className=" body-font overflow-hidden bg-white mb-10 justify-center shadow-xl pb-10 ">
          {/* Product details */}
          <div className=" px-5 md:py-16 flex flex-wrap w-full">
            ...
            <div className=" mx-auto flex flex-wrap justify-center ">
              ...
              <div className="lg:w-1/2 w-full lg:pl-10  mt-6 lg:mt-0">
                ...
                {Array.isArray(product.colorsInfo) &&
                  Array.isArray(product.sizesInfo) &&
                  product?.sizesInfo?.length > 0 &&
                  product?.colorsInfo?.length > 0 && (
