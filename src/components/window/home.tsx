          ...
          <div className="flex flex-col-reverse md:flex-row justify-center items-center">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm px-3 text-neutral-700 mb-8 max-w-xl">
                Welcome to our platform, where we curate an unparalleled
                selection of products meticulously crafted with passion and
                precision, exclusively for you to discover and cherish.
              </p>
              <div className="p-2">
                <Link href="/product">
