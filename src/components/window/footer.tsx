          ...
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
              <h6 className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
                <Image
                  ...
                  height={100}
                />
                <span className="ml-3 font-bold italic uppercase text-lg">
                  {" "}
                  Online Shop
                </span>
              </h6>
              <p className="mb-4 font-sm text-neutral-600 italic">
            ...
            <div>
              ...
              <p className="mb-4">
                <Link
                  href="cart"
                  className="text-neutral-600 dark:text-neutral-200 hover:text-blue-500"
                >
                  My Cart
                </Link>
              </p>
            ...
            <div>
              <h6 className="mb-4 text-gray-600 flex justify-center font-semibold uppercase md:justify-start">
                Useful links
              </h6>
